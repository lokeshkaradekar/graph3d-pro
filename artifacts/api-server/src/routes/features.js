...
router.get("/me", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, feature_service_1.getUserFeatures)(req.user.id)];
            case 1:
                features = _a.sent();
...
router.get("/check/:feature", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var featureName, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                featureName = req.params["feature"];
                if (!featureName) {
                    res.status(400).json({ error: "Feature name is required." });
                    return [2 /*return*/];
                }
                return [4 /*yield*/, (0, feature_service_1.hasFeature)(req.user.id, featureName)];
            case 1:
                result = _a.sent();
                res.json({
                    feature: featureName,
