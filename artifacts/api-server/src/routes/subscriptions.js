...
router.get("/plans", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, subscription_service_1.getPublicPlans)()];
            case 1:
                plans = _a.sent();
...
router.get("/me", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, active, history;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, Promise.all([
                    (0, subscription_service_1.getActiveSubscription)(req.user.id),
                    (0, subscription_service_1.getSubscriptionHistory)(req.user.id),
                ])];
            case 1:
                _a = _b.sent(), active = _a[0], history = _a[1];
...
var cancelSchema = zod_1.z.object({
    subscriptionId: zod_1.z.string().uuid(),
    immediate: zod_1.z.boolean().optional().default(false),
});
router.post("/cancel", require_verified_1.requireVerified, (0, validate_1.validate)(cancelSchema), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, subscriptionId, immediate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, subscriptionId = _a.subscriptionId, immediate = _a.immediate;
                return [4 /*yield*/, (0, subscription_service_1.cancelSubscription)(req.user.id, subscriptionId, !immediate)];
            case 1:
                _b.sent();
...
router.get("/history", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, subscription_service_1.getSubscriptionHistory)(req.user.id)];
            case 1:
                history = _a.sent();
