...
var updateProfileSchema = zod_1.z.object({
    displayName: zod_1.z.string().max(80).optional(),
...
router.get("/me", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, user_service_1.findUserById)(req.user.id)];
            case 1:
                user = _a.sent();
                if (!user) {
...
// ── PATCH /api/users/me ───────────────────────────────────────────────────────
router.patch("/me", (0, validate_1.validate)(updateProfileSchema), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var updated;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, user_service_1.updateProfile)(req.user.id, req.body)];
            case 1:
                updated = _a.sent();
                if (!updated) {
                    res.status(404).json({ error: "User not found." });
...
router.delete("/me", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, session_service_1.destroyAllUserSessions)(req.user.id)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, user_service_1.softDeleteUser)(req.user.id)];
            case 2:
                _a.sent();
